 ...
 *      RL-ARM - RTX
 *----------------------------------------------------------------------------
 *      Name:    SYKAM/DEVICE/S5151_COOL/CFG/RTX_CONFIG.C
...
#define OS_TRV          ((U32)(((double)OS_CLOCK*(double)OS_TICK)/1E6)-1)  /* RR: Tick timer interrupt reload value */
 ...
 #define OS_TINIT()     SYS->PMC_PCER           = OS_TIM_;                 /*  Initialization  */ \
                        ...
                        AIC->AIC_SMR[ID_TC]     =  AT91C_AIC_SRCTYPE_INT_POSITIVE_EDGE | AT91C_AIC_PRIOR_LOWEST;
 ...
 #define OS_TINIT()     SYS->PITC_PIMR          = OS_TRV | AT91C_PITC_PITIEN | AT91C_PITC_PITEN;  /*  Initialization --> RR: function 
                                                                                                      will be called in os_sys_init(); 
                                                                                                      OS_TRV (tick timer reload value) 
                                                                                                      set by user */ \
                        AIC->AIC_SPU            =  (U32)os_def_interrupt;           \
                        AIC->AIC_SVR[ID_TC]     =  (U32)sys_ctrl_interrupt;         \
                        AIC->AIC_SMR[ID_TC]     =                                   \
